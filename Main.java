...
public class Main {
    ...
    try {
        try{
            for(;;) {
                System.out.println("Enter the tanks's number to find out its color: ");
                String[] cats = {"Green", "Yellow", "Grey"};
                int n = sc.nextInt();
                System.out.println("Tank color is: " + cats[n]);
            }
        }catch (ArrayIndexOutOfBoundsException e){
            System.out.println("You found the Ratte(ArrayIndexOutOfBoundsException): "+e);
        }
